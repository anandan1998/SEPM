...
class Game:
    ...
    def __init__(self, n):
        ...
        self.board = [[] for i in range(self.total_squares)]  # Replaced xrange with range
        self.turn = 0
        if n == 5:
            self.max_flats = 21
            self.max_standing = 1
        ...
        self.moves = 0
        self.players = []
        self.players.append(Game.Player(self.max_flats, self.max_standing))
        self.players.append(Game.Player(self.max_flats, self.max_standing))
        self.all_squares = [self.square_to_string(i) for i in range(self.total_squares)]  # Replaced xrange with range
    ...
    def partition(self, n):
        ...
        part_list = []
        part_list.append([n])
        for x in range(1, n):  # Replaced xrange with range
    ...
    def check_valid(self, square, direction, partition):
        ...
        if direction == '+':
            ...
            change = -1
        for i in range(len(partition)):  # Replaced xrange with range
    ...
    def generate_stack_moves(self, square):
        ...
        all_moves = []
        r = square % self.n
        c = square // self.n  # Integer division
        ...
        for num in range(min(size, self.n)):  # Replaced xrange with range
    ...
    def generate_all_moves(self, player):
        ...
        '''
        all_moves = []
        for i in range(len(self.board)):  # Replaced xrange with range
            if len(self.board[i]) == 0:
                ...
                if self.moves != player and self.players[player].Standing > 0:
